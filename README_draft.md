...
|--------------------|---------------|----------- |-------|
| RandLA-Net (tf)    | 53.7 [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_semantickitti_202010091306.zip) |  64.0  |  67.0 [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_s3dis_202010091238.zip)    |
