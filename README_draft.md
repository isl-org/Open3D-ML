...
|--------------------|---------------|------------|-------------|-------|
| RandLA-Net (tf)    | 53.7 [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_semantickitti_202010091306.zip) |  64.0         |  76.0         |  67.0 [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_s3dis_202010091238.zip)    |
| RandLA-Net (torch) | 52.0 [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_semantickitti_202009090354utc.pth)        |     61.0  [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_toronto3D_202010091306.pth)   |  76.0         |  67.0 [:floppy_disk:](https://storage.googleapis.com/open3d-releases/model-zoo/randlanet_s3dis_202010091238.pth)  |
