...
class MegaLoader():
    ...
    def __init__(self,
        ...
        if height_offset is not None:
            assert len(height_offset) == self.num_datasets
...
class MegaLoaderSplit():
    ...
    def __init__(self, dataset, split='training', test_dataset_idx=2):
        ...
        self.height_offset = dataset.height_offset
    ...
    def get_data(self, idx):
        ...
        data['feat'][:, 0] = norm(data['feat'][:, 0])
        if self.height_offset is not None:
            data['point'][:, 2] -= self.height_offset[dataset_idx]
