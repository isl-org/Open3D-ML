...
class RandLANet(nn.Module):
    def __init__(self, cfg = None, num_layers = 4, d_feature = 8, d_in = 3, d_out = [16, 64, 128, 256], batcher = 'DefaultBatcher',
                num_classes = 8, num_points = 65536, sub_sampling_ratio = [4, 4, 4, 4, 2], grid_size = 0.06, k_n = 16,
        ...
        if cfg is None:
            cfg = dict(
                ...
                grid_size = grid_size,
                ckpt_path = Path(abspath(__file__)).parent.parent / 'checkpoint' / ckpt_name,
